	...
	public function index()
	{
		...
		if ($this->form_validation->run()) {
			...
			$fields = array(
				...
				'cs_time_limit'   => array('type' => 'INT', 'constraint' => 11, 'unsigned' => TRUE, 'default' => 2000),
			...
			$fields = array(
				...
				'family'	          => array('type' => 'VARCHAR', 'constraint' => 255, 'default' => ''),
				'institution'         => array('type' => 'VARCHAR', 'constraint' => 255, 'default' => ''),
				'student_id'          => array('type' => 'VARCHAR', 'constraint' => 50, 'default' => ''),
